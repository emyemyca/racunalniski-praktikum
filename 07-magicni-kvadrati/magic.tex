...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Put this in the preamble (before \begin{document}), replacing the broken block.
...
\begin{izrek}  
Magična konstanta normalnega magičnega kvadrata reda \ref{eq:mc} je enaka
   \begin{equation}
      \label{eq:numbers}
...
% Začetek dokaza
 ...
 \end{proof} 
 \[
 \mathcal{M}_{2}(n; A, D) = \frac{1}{2} n \left(2A + (n^{2} - 1) \right)
 \]
   % Konec dokaza
...
\begin{tabular}{lcccccc}\toprule
      & \multicolumn{5}{c}{točna vrednost} & priblžek \\
      \midrule
      red & 1 & 2 & 3 & 4 & 5 & 6 \\ 
