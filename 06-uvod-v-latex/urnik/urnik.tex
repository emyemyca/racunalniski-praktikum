...
XML datoteki predstavljen je profesor Janez Novak, ki triktrat na tden predava predmet matematika.
\begin{verbatim}
<profesor>
   <ime>Janez</ime>
...
% To popravite z ukazom `\noindent` ali pa tako, da odstranite prazno vrstico.
% (Nekoliko lepše izgleda, če v prazno vrstico vstavite % za komentar.)
\subsection{Program za iydelavo urnika}
\noindent
...
Požrešna metoda je ena izmed strategij, s katerimi lahko rešujemo optimizacijske probleme -to pomeni, da za dani problem iščemo najboljšo (optimalno) rešitev. Metoda na vsakem koraku
